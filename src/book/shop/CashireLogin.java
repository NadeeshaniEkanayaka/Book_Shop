 ...
 * @author NADEESHANI
 */
public class CashireLogin extends javax.swing.JFrame {

    /**
     * Creates new form CashireLogin
     */
    public CashireLogin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashireLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CashireLogin().setVisible(true);
            }
        });
    }
