...
public class MainIterface extends javax.swing.JFrame {
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/book/shop/icons8_next_page_40px.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/book/shop/icons8_school_80px_2.png"))); // NOI18N

        jLabel6.setFont(new java.awt.Font("Old English Text MT", 0, 18)); // NOI18N
        jLabel6.setText("City Booksshop");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainIterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MainIterface().setVisible(true);
        });
    }
